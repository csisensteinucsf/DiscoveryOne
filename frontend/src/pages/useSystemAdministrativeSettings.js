...
export function useSystemAdministrativeSettings({
  ...
  const applyAdministrativeSettings = useCallback((data = {}) => {
    ...
    setNtpSettings({
      ...
      ack_automate_url: ntp.ack_automate_url || '',
      ack_display_url: ntp.ack_display_url || '',
      ack_automate_secret: ntp.ack_automate_secret || '',
  ...
  const saveNtpSettings = useCallback(async () => {
    ...
    try {
      const payload = {
        ...
        ack_automate_url: (ntpSettings.ack_automate_url || '').trim(),
        ack_display_url: (ntpSettings.ack_display_url || '').trim(),
        ack_automate_secret: ntpSettings.ack_automate_secret || '',
      ...
      setNtpSettings({
        ...
        ack_automate_url: next.ack_automate_url || '',
        ack_display_url: next.ack_display_url || '',
        ack_automate_secret: next.ack_automate_secret || '',
