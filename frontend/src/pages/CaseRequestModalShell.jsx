    ...
    <Modal
      ...
      footer={(
        <div className="case-editor-footer">
          {showMissingRequired ? <div className="case-editor-missing-required" role="alert">Missing required fields</div> : null}
