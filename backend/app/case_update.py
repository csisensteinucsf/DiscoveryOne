...
def update_case_record(
    *,
    ...
    for field in ("name", "legal_case_name", "claimant", "closed", "is_private", "is_test_case", "color", "description", "rubrik_restore_ticket", "box_hold_ticket", "is_active_case", "closure_nag_days"):
